            ...
            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-orange-400 divide-y-2 divide-gray-50">
              ...
              <div className="py-6 px-5 space-y-6">
                ...
                <div>
                  <a
                    href="#"
                    className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-orange-400 bg-gray-900 hover:bg-gray-900"
                  >
                    Sign up
                  </a>
