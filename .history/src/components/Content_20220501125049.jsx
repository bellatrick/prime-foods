      ...
      <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            ...
            <Fade right>
              <div className="mt-6 text-gray-100 space-y-6 text-left">
                <p className="text-base flex flex-column gap-6 leading-7">
                  <span>
                    {" "}
                  ...
                  <span>
                    {" "}
                    2. a bowl, pour a cup of Semovita in it and add some cool
                    water into the bowl. Use the wooden spatula to stir the
                    water and Semovita continuously until a smooth consistency
                    is achieved.
                  </span>
                  <br />
                  <span>
                    ...
                    Semovita into the boispanng water.{" "}
                  </span>
                  <br />
                  <span>
                    {" "}
