...
export default function Example() {
  return (
    <div className="bg-white relative" id="contact-us">
        ...
        <div className="bg-orange-600 rounded-lg shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
          <div className="pt-6 pb-12 px-6 sm:pt-10 sm:px-16 lg:py-16 lg:pr-0 xl:py-16 xl:px-20">
            <div className="lg:self-center">
              ...
              <Slide left>
                <div className="mt-4 flex justify-center rounded-md shadow sm:mt-8 sm:ml-3 cursor-pointer">
                  <a
                    href={`https://wa.me/${'+2348108932677'}/?text=${'Hello, i just got off your website and i would like to...'}`}
                    rel="noreferrer"
                    className="w-64 flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md bg-white text-orange-600 hover:bg-orange-400 hover:text-white cursor-pointer md:py-4 md:text-lg md:px-10"
                  >
                    Contact us
                  </a>
                </div>
