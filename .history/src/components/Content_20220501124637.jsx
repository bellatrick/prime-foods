            ...
            <Fade right>
              <div className="mt-6 text-gray-100 space-y-6">
                <p className="text-base leading-7">
                  ...
                  3. When the water in the pot is boiling, reduce the heat of
                  the stove to medium heat and then, pour the mixed Semovita
                  into the boiling water. 4. Continue stirring for 1-2 minutes
                  and then allow to cook on low heat for about a minute. 5. Stir
                  again until the texture is consistent and then turn off the
                  heat.
                </p>
              </div>
            </Fade>
