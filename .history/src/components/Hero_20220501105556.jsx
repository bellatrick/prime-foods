        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            ...
            <div className="flex gap-8 text-white font-bold cursor-pointer  ">
              <a className="hover:bg-orange-600 hover:text-white w-32 py-2 text-orange-400 bg-gray-800 rounded-md" href='#About'>About </a>
              <a className="hover:bg-orange-600 hover:text-white w-32 py-2 text-orange-400 bg-gray-800 rounded-md" href='#contact-us'>Contact us</a>
            </div>
          </div>
        </div>
      </Popover>
            ...
            <Fade top opposite>
              <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
                <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                  <a
                    href="#about-us"
                    className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md hover:bg-orange-600 hover:text-white w-32 py-2 text-orange-400 bg-gray-800  cursor-pointer md:py-4 md:text-lg md:px-10"
                  >
                    Learn more
                  </a>
                </div>
