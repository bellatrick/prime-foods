...
const Container = styled.div`
  ...
  height: 100%;
`;
const CarouselUI = ({ children }) => <div className="className="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full"">{children}</div>;
