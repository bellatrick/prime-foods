            ...
            <Fade top opposite>
              <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
                <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                  <a
                    href="#about"
                    className="w-full z-10 flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md hover:bg-orange-600 hover:text-white text-orange-600 bg-gray-800  cursor-pointer md:py-4 md:text-lg md:px-10"
                  >
                    Learn more
                  </a>
                </div>
