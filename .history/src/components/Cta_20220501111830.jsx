    ...
    <div className="bg-white relative" id="contact-us">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="bg-orange-600 rounded-lg shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
          <div className="pt-4 pb-12 px-6 sm:pt-10 sm:px-16 lg:py-16 lg:pr-0 xl:py-16 xl:px-20">
            <div className="lg:self-center">
              <h2 className="text-2xl font-extrabold text-white sm:text-4xl">
                ...
                <Slide left>
                <div className="mt-2 rounded-md shadow sm:mt-8 sm:ml-3 cursor-pointer z-10">
                  <a
