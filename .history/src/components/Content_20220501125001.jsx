      ...
      <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            <Fade left>
              <h2 className="text-3xl text-gray-300 text-start font-extrabold tracking-tight sm:text-4xl">
                How to prepare Yuca Flour
              </h2>
            </Fade>
            <Fade right>
              <div className="mt-6 text-gray-100 space-y-16 text-left">
                <p className="text-base leading-7 space-y-8">  
                    <span>
                      {" "}
