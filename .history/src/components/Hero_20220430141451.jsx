        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            ...
            <Popover.Group as="nav" className="hidden md:flex space-x-10">
              ...
              <a href="#" className="text-base font-medium text-gray-50 hover:text-gray-900">
                Pricing
              </a>
              <a href="#" className="text-base font-medium text-gray-50 hover:text-gray-900">
                Docs
                        ...
                        <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                          ...
                          <div className="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
                            ...
                            <div className="mt-5 text-sm">
                              <a href="#" className="font-medium text-gray-600 hover:text-gray-50">
                                {' '}
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <a href="#" className="orange-400space-nowrap text-base font-medium text-gray-50 hover:text-gray-900">
                Sign in
              </a>
              <a
                href="#"
